package com.ecommerce.core.product.application;

import com.ecommerce.core.product.application.dto.ProductInfo;
import com.ecommerce.core.common.ResponseEntity;
import com.ecommerce.core.product.application.dto.ProductCommand;
import com.ecommerce.core.product.application.dto.ProductInfo;
import com.ecommerce.core.product.domain.Product;
import com.ecommerce.core.product.domain.ProductRepository;
...
public class ProductService {
    ...
    public ResponseEntity<ProductInfo> create(ProductCommand command) {
        ...
        return new ResponseEntity<>(HttpStatus.CREATED.value(), ProductInfo.from(saved), 1L);
    }
    ...
    public ResponseEntity<ProductInfo> update(UUID productId, ProductCommand command) {
        ...
        return new ResponseEntity<>(HttpStatus.OK.value(), ProductInfo.from(updated), 1L);
    }
